                ...
                {products.map((product, index) => {
                    return <tr key={index} className='border-b bg-gray-800 border-gray-700'>
                        ...
                        <th className='flex flex-nowrap items-center justify-center px-6 py-3'>
                            ...
                            <button className='focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-4 py-2.5 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900'>Eliminar</button>
                        </th>
                    </tr>
                }
                )}
