...
<form className="font-source font-bold ">
    <div class="mb-6">
        <label for="name" class="block mb-2 text-sm font-medium text-setBlue-300 dark:text-gray-300">Your name</label>
    ...
    <div class="mb-6">
        <label for="email" class="block mb-2 text-sm font-medium text-setBlue-300 dark:text-gray-300">Your email</label>
        <input type="email" id="email" class="shadow-sm bg-gray-50 border border-gray-300 text-setBlue-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder="user@factozon.com" required/>
    </div>

    <div class="mb-6">
        <label for="password" class="block mb-2 text-sm font-medium text-setBlue-300 dark:text-gray-300">Your password</label>
    ...
    <div class="mb-6">
        <label for="repeat-password" class="block mb-2 text-sm font-medium text-setBlue-300 dark:text-gray-300">Repeat password</label>
    ...
    <div class="flex items-start mb-6">
        ...
        <button type="submit" class="text-setGray-100 bg-setOrange hover:bg-orange-400 focus:ring-4 focus:outline-none focus:ring-blue-300 font-bold rounded-lg text-xl px-5 py-2.5 text-center dark:bg-setOrange-600 dark:hover:bg-setOrange-700 dark:focus:ring-blue-800">Register new account</button>
...
if (document.getElementById("formcreateuser")) {
    ReactDOM.render(<Formcreateuser />, document.getElementById("formcreateuser"));
}